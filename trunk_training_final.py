...
def rebalance_edge_center(X, y, edge_ratio=0.7, grid_size=3):
    """
...
def load_and_prepare_multi_person_data(csv_paths, video_paths, frame_segments, num_samples=None, edge_focused=False):
    ...
    for i, (csv_path, video_path) in enumerate(zip(csv_paths, video_paths)):
        ...
        batch_size = 1000  # Smaller batch size for testing
        ...
        if edge_focused and len(y) > 0:
            X, y = rebalance_edge_center(X, y, edge_ratio=EDGE_TARGET_RATIO, grid_size=EDGE_GRID_SIZE)
...
if __name__ == "__main__":
    ...
    frame_segments = [
        [(7984, 8882), (20908, 21906)],
        [(17564, 18512), (20658, 21506)],
        [(5613, 6412), (16666, 17539)]
    ]
